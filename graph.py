...
g = Graph(3)
g.initial_assignment('examples/9by9_1.txt')
#g.initial_assignment('examples/9by9_2.txt')
print(g)

h = Graph(2)
h.initial_assignment('examples/4by4_1.txt')
#h.initial_assignment('examples/4by4_2.txt')
print(h)

i = Graph(4)
i.initial_assignment('examples/16by16_1.txt')
print(i)
